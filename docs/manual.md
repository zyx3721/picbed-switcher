...
> **文档说明**：本文档由原 `README.md` 迁移而来，保留了全部细节（本地开发、Docker Compose 部署、生产环境部署、Nginx 与 HTTPS 示例、API 清单、使用说明与常见问题），作为项目的完整手册使用。
>
> 项目概览、功能说明与部署入口请回到 [README.md](../README.md)；英文版见 [README.en.md](../README.en.md)。
